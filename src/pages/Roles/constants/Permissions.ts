...
import { Roles as RolesEnum } from '@/config/roles';
...
export const PERMISSION_GROUPS = {
  ...
  invoices: {
    ...
    nameAr: 'الفواتير',
    permissions: rolePermissions[RolesEnum.ORDERS],
  },
  priceQuotes: {
    name: 'PRICE_QUOTES_AUTHORITIES',
    nameAr: 'عرض السعر',
    permissions: rolePermissions[RolesEnum.PRICE_QUOTES],
  },
  purchasing: {
    name: 'PURCHASING_AUTHORITIES',
    nameAr: 'المشتريات',
    permissions: rolePermissions[RolesEnum.PURCHASING],
  },
  inventory: {
    name: 'INVENTORY_AUTHORITIES',
    nameAr: 'المخزون',
    permissions: rolePermissions[RolesEnum.INVENTORY],
  },
  customers: {
    name: 'CUSTOMER_AUTHORITIES',
    nameAr: 'العملاء',
    permissions: rolePermissions[RolesEnum.CUSTOMERS],
  },
  suppliers: {
    name: 'SUPPLIER_AUTHORITIES',
    nameAr: 'الموردين',
    permissions: rolePermissions[RolesEnum.SUPPLIERS],
  },
  reports: {
    name: 'REPORTS_AUTHORITIES',
    nameAr: 'التقارير',
    permissions: rolePermissions[RolesEnum.REPORTS],
  },
  paymentMethods: {
    name: 'PAYMENT_METHODS_AUTHORITIES',
    nameAr: 'طرق الدفع',
    permissions: rolePermissions[RolesEnum.PAYMENT_METHODS],
  },
  users: {
  ...
  branches: {
    ...
    nameAr: 'الفروع',
    permissions: rolePermissions[RolesEnum.BRANCHES],
  },
  settings: {
    name: 'SETTINGS_AUTHORITIES',
    nameAr: 'الاعدادات',
    permissions: rolePermissions[RolesEnum.SETTINGS],
  },
};
