      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex space-x-2">
            ...
            <div className="flex flex-col max-w-[79px]">
              <div className="flex relative flex-col items-end px-4 pt-3 pb-10 w-full aspect-[1.162]">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/d73659d410d0be52d235422a1465665c35c310c8baa9eab3835007e3361872e6?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e"
