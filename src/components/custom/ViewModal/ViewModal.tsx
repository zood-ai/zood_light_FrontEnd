...
export const ViewModal: React.FC<ViewModalProps> = () => {
  return (
    <>
      <div className="flex flex-wrap gap-4 rounded-none h-[80vh] overflow-y-scroll relative">
      <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/ad12ada4a7acd7a2eb6be704af50ef52a8c6bd7b621a9cb8680abf0ae50c9937?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e"
          className="object-contain shrink-0 self-start mt-4 w-11 aspect-square  "
        />
        <div className="flex flex-col grow shrink-0 justify-center items-center px-16 py-10 rounded-lg bg-white   ">
          <div className="flex flex-wrap gap-9 items-end max-md:max-w-full ">
            <div className="flex flex-col min-w-[240px] w-[293px]">
              ...
              <div className="flex flex-col self-end mt-24 max-w-full rounded-none w-[154px] max-md:mt-10">
                <div className="flex flex-col justify-center px-4 py-5 bg-white rounded-lg border border-gray-200 border-solid max-md:px-5">
                  <img
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/10500ea02d2862de165e84e02754c3cb9c2ffc1bbd685d1c3c84c4deb7e8a93e?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e"
            ...
            <div className="flex gap-2.5 items-center px-6 py-5 text-sm bg-white rounded-lg border border-gray-200 border-solid min-h-[775px] min-w-[240px] text-zinc-800 w-[480px] max-md:px-5 max-md:max-w-full">
              <div className="flex flex-col self-stretch my-auto min-w-[240px] w-[426px]">
                  ...
                  <div className="flex flex-col w-full max-md:max-w-full">
                    <div className="flex flex-col w-full max-md:max-w-full">
                      ...
                      <div className="flex flex-col mt-3.5 w-full text-right max-md:max-w-full">
                        <img
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/8e66c7a562425f265845f12182d4fabf931386a261a10d959a7603f1db3b859c?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e"
                          className="object-contain w-full aspect-[500] max-md:max-w-full"
                        />
                        <div className="flex flex-col justify-center mt-5 w-full max-md:max-w-full">
                          ...
                          <img
                            loading="lazy"
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/8e66c7a562425f265845f12182d4fabf931386a261a10d959a7603f1db3b859c?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e"
                            className="object-contain mt-4 w-full aspect-[500] max-md:max-w-full"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col w-full max-md:max-w-full">
                      ...
                      <div className="flex flex-col self-end mt-4 max-w-full w-[365px]">
                        ...
                        <div className="flex gap-10 justify-between items-center self-end mt-1 max-w-full w-[329px]">
                          ...
                          <div className="self-stretch my-auto">مبلغ مستحق</div>
                        </div>
                      </div>
                    </div>
                    <img
                ...
                <img
                  loading="lazy"
                  srcSet="https://cdn.builder.io/api/v1/image/assets/TEMP/afcd923d029c9d565dc6a2eab3cb07abf7232c2807e26f83f8bb86f851f3f481?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e&width=100 100w, https://cdn.builder.io/api/v1/image/assets/TEMP/afcd923d029c9d565dc6a2eab3cb07abf7232c2807e26f83f8bb86f851f3f481?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e&width=200 200w, https://cdn.builder.io/api/v1/image/assets/TEMP/afcd923d029c9d565dc6a2eab3cb07abf7232c2807e26f83f8bb86f851f3f481?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e&width=400 400w, https://cdn.builder.io/api/v1/image/assets/TEMP/afcd923d029c9d565dc6a2eab3cb07abf7232c2807e26f83f8bb86f851f3f481?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e&width=800 800w, https://cdn.builder.io/api/v1/image/assets/TEMP/afcd923d029c9d565dc6a2eab3cb07abf7232c2807e26f83f8bb86f851f3f481?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e&width=1200 1200w, https://cdn.builder.io/api/v1/image/assets/TEMP/afcd923d029c9d565dc6a2eab3cb07abf7232c2807e26f83f8bb86f851f3f481?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e&width=1600 1600w, https://cdn.builder.io/api/v1/image/assets/TEMP/afcd923d029c9d565dc6a2eab3cb07abf7232c2807e26f83f8bb86f851f3f481?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e&width=2000 2000w, https://cdn.builder.io/api/v1/image/assets/TEMP/afcd923d029c9d565dc6a2eab3cb07abf7232c2807e26f83f8bb86f851f3f481?placeholderIfAbsent=true&apiKey=8679f2257b144d7b937e32f7e767988e"
