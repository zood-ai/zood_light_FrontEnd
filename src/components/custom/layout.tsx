  ...
  ({ className, sticky, ...props }, ref) => {
    ...
    return (
      <div
        ...
        data-layout='header'
        className={cn(
          `z-10 flex h-[var(--header-height)] items-center gap-4 bg-mainBg p-4 md:px-8`,
          contextVal.offset > 10 && sticky ? 'shadow-0' : 'shadow-none',
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      data-layout='body'
      className={cn(
        'px-4 py-[32px] md:overflow-hidden md:px-8 bga-[#FCFCFC]',
