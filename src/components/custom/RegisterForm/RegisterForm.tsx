...
export const RegisterForm: React.FC<RegisterFormProps> = () => {
  ...
  return (
    <>
      <div
        className="flex flex-col rounded-none  px-[161px] bg-mainBg"
        dir={isRtl ? 'rtl' : 'ltr'}
      >
        <div className="flex flex-col self-start w-full max-w-[1146px] max-md:max-w-full">
          <div className="flex flex-col text-base font-semibold rounded-none text-zinc-100">
            <div className="flex flex-wrap gap-5 justify-between px-7 py-1.5 w-full bg-white rounded-lg border border-gray-200 border-solid max-md:px-5 max-md:max-w-full">
              <div className="flex flex-wrap gap-6 my-auto max-md:max-w-full">
                <div className="flex gap-2 px-5 py-3 bg-green-500 rounded-lg">
                ...
                <div className="flex shrink-0 my-auto w-11 h-11 bg-white rounded-lg border border-gray-200 border-solid justify-center items-center">
                  <svg
                    width="23"
                    height="28"
                    viewBox="0 0 23 28"
              ...
              <img
                ...
                className="object-contain shrink-0 aspect-[0.81] w-[51px] "
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mt-4 w-full max-md:max-w-full">
        ...
        <div className="mt-3 w-full max-md:max-w-full">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 ">
            <div className="flex flex-col mt-7 w-full col-span-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 w-full max-md:max-w-full ">
