...
export default function LabourCharts({
  salesChartData,
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="flex items-center w-full gap-2 font-bold">
          <p className="text-[18px] ">
            <span className="font-semibold">Actual v Planned Labour</span>
            {fromDate}-{toDate}{" "}
          </p>
          {/* <span className="text-primary text-[14px]">Show month</span> */}
        </div>

        <div className=" flex gap-[32px] border-b-2 w-[300px] justify-self-end mb-[35px]">
          <p
