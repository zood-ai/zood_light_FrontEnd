...
interface IPriceChangesForm {
  PriceChange: any;
}
const PriceChangesForm = ({ PriceChange }: IPriceChangesForm) => {
  return (
    <div className="pb-20">
      {/* invoice info */}
      ...
      {/* credit notes */}
      {PriceChange?.creditNotices?.length > 0 && (
            ...
            <div className="flex items-center justify-between border-b border-b-[#EDEDED] pb-2">
              ...
              <div className="flex items-center gap-[112px]">
                ...
                <span className="text-textPrimary">
                  SAR {item?.pivot?.sub_total?.toFixed(2)}
                </span>
              </div>
            </div>
          ))}
...
export default PriceChangesForm;
