  ...
  return (
    <>
      <Input
        type="text"
        label="Rule name"
        placeholder="Type the rule's name"
        className="w-[300px]"
        value={watch("name")}
        onChange={(e) => {
      ...
      <div className="mt-5 p-5 bg-popover rounded-[4px] ">
        {watch("scenario") == 1 ? (
          <div className="flex items-center gap-2 mb-3">
            <p>When the employee works a shift that falls on</p>
            <CustomSelect
              options={DaysOptions}
              value={watch("day")}
              width="w-[100px]"
          ...
          <div className="flex items-center gap-2 mb-3">
            <p>When the employee works over</p>
            <Input
              type="number"
              step={"0.01"}
              min={0}
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <p>times their regular pay rate</p>
        </div>
      </div>
          ...
          <div className="flex items-center space-x-2 mt-5">
            ...
            <div className="flex items-center space-x-2 ">
              <Checkbox
                ...
                onCheckedChange={(e) => {
                  setValue("applies_to_salaried", !!e, {
                    shouldValidate: true,
                    shouldDirty: true,
                  });
                }}
