...
const Tags = () => {
  const { tagsSelect } = useCommonRequests({ typeTag: "2" });
                  ...
                  onValueChange={(e) => {
                    const newValue =
                      field.value !== undefined
                        ...
                        : [{ id: e }];
                    field.onChange(
                      !field.value?.find((el: { id: string }) => el.id === e)
                        ? newValue
                        : field.value
                    );
                  }}
